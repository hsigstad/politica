...
def configuration_test(ARGUMENTS, gslab_python_version):
    ...
    misc.load_yaml_value("user-config.yaml", "external_external-mirror_directory")
    misc.load_yaml_value("user-config.yaml", "external_local_directory")
