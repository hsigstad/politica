# INTENT: Build build/clean/despesa_contratada.csv — candidate "contracted"
# campaign expenditures, one row per despesa, tagged with the candidate's CPF
# and SQ_CANDIDATO recovered from the matching receita file.
# SOURCE: TSE prestação-de-contas BRASIL files (despesas_contratadas_candidatos
